...
%
% DESCRIPTION
% This script creates the Figures 2a,b,c in Sloan and Feng (2023)
%
% =========================================================================
...
close all
   ...
   [h,ax] = plotScatter(Obs_filt.SWC_nep,Obs_filt.LE*86400/2.5e6,...
    ...
    fh = gcf;
    fh.Position(3)/2.54
    print([spath,'fig-02a'],'-dpng','-r1200')
    ...
    print([spath,'fig-02b-2'],'-dpng','-r1200')
