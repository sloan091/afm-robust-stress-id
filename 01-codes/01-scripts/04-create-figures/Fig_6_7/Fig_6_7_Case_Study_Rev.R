################################################################################ 
# Name: Fig_6_7_Case_Study_Rev
# By: Brandon Sloan
# Last Updated: 6/2/23
# Description: Creates the slope and performance distributions for the case 
# study sites in Sect. 3.3 and Sloan and Feng (2023).  These distributions
# are derived from the 2,304 assumption sets.
################################################################################
